...
../nanopb-0.4.9/generator-bin/protoc --experimental_allow_proto3_optional "--nanopb_out=-S.cpp -v:../components/meshtastic/generated/" -I=../meshtastic-protobufs meshtastic/*.proto
